function tolerance_config = create_tolerance_config(position_tolerance, orientation_tolerance, articulation_tolerance)
    ...
    %   tight_tol = components.goal_checker.helpers.create_tolerance_config(0.5, 5.0, 3.0);
    %
    %   % Create relaxed tolerances for highway
    %   relaxed_tol = components.goal_checker.helpers.create_tolerance_config(3.0, 20.0, 15.0);
    %
    %   % Use defaults
    %   default_tol = components.goal_checker.helpers.create_tolerance_config();
