function vehicle_state = create_vehicle_state(x, y, theta, gamma, vehicle_type)
    ...
    %   state = components.goal_checker.helpers.create_vehicle_state(60, 64, 270, 5, 'articulated');
    %
    %   % Create car vehicle state  
    %   state = components.goal_checker.helpers.create_vehicle_state(60, 64, 270, 0, 'car');
